...
if __name__ == '__main__':
    ...
    base_model = model_class.from_pretrained(
        ...
        trust_remote_code=True if args.model_name in ["chatglm", "baichuan"] else False
    )
    end = time.time()
        ...
        if args.interactive:
            ...
            while True:
                ...
                generation_output = model.generate(
                    ...
                    pad_token_id=tokenizer.pad_token_id if args.model_name != "baichuan" else tokenizer.eos_token_id,
                    **generation_config
                )
